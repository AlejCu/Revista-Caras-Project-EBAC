    ...
    <NewsLetterSection>
        ...
        <article className="newsletter-main-container">
            ...
            <div className="newsletter-img-container">
                ...
                <img src={`${process.env.PUBLIC_URL}/media/caras-cover-newsletter.jpg`}  alt="Portada de la revista CARAS edicion Mayo 2024" id="newsletter-img" fetchPriority='high'/>
